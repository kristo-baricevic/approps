  ...
  return (
    <main className="min-h-screen bg-slate-950 px-4 py-8">
        ...
        <header className="mb-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="">
            <Link
              ...
              target="_blank"
              className="inline-flex items-center rounded-lg border border-slate-600 bg-slate-900/70 px-3 py-2 text-sm text-slate-200 hover:bg-slate-700 transition mb-4"
            >
              <svg
      ...
      0 .268.18.58.687.482A10.019 10.019 0 0 0 22 12.017C22 6.486 17.522 2 12 2z"
          ...
          <div className="flex items-center space-x-3 rounded-full border border-slate-700 bg-slate-900/70 px-3 py-2 shadow-sm shadow-black/40 mb-4">
